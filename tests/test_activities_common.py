...
from datamodels.prompts import Prompts, AgentPrompts
...
class TestGetConfigs:
    ...
    async def test_get_configs_success(self, test_config):
        ...
        with patch("activities.common.load_config", return_value=test_config):
...
class TestGetPrompts:
    ...
    async def test_get_prompts_success(self, test_prompts):
        ...
        with patch("activities.common.read_prompts", return_value=prompts_obj):
