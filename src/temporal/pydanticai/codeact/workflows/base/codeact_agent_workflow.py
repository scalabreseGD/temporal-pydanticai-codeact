...
with workflow.unsafe.imports_passed_through():
    from temporal.pydanticai.codeact.datamodels.sandbox import SandboxTaskTypes, StartContainerArgs, SandboxBaseArgs
    from temporal.pydanticai.codeact.datamodels.codeact import CodeActAgentOutput, CodeActAgentDeps
    from temporal.pydanticai.codeact.datamodels.prompts import AgentPrompts, Prompts
